...
\examiners{Docent Patrik Floréen}
...
En drönare, det vill säga en flygande robot, har använts till att skaffa visuell information från katastrofområden och till att förhindra industriolyckor. För att vara användbara måste drönare kunna navigera autonomt i miljöer. Navigering är ett forskningsområde som har utvecklats under de senaste årtionden. För att en drönare skulle kunna navigera autonomt måste den vara medveten om sitt läge, sin omgivning, och sin hastighet. En viktig del i autonom navigering för drönare är att den kan samtidigt kartlägga omgivningen och lokalisera sig själv i den. 

Visionsbaserad navigering med kameror är ett lovande forskningsområde inom robotnavigering. Med hjälp av datorer som används i visionsbaserad navigering går det att kartlägga omgivningen och lokalisera sig själv i den. Kameror används för att extrahera egenskaper ur bilder och de är inte beroende på en utomstående entitet för att skaffa data om omgivningen. Syftet med denna avhandling är att undersöka visionsbaserad navigering från drönarens perspektiv med fokus på samtidig kartläggning och lokalisering och hur detta problem har angripits.
\end{abstract}
