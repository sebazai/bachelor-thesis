...
Robotars förmåga att navigera är ett forskningsområde som har gått framåt under de senaste årtionden. En drönare, som är en flygande robot, har använts för att skaffa visuell information av katastrofområden och att övervaka industriolyckor. Att en robot skulle kunna navigera autonomiskt måste den vara medveten om sitt läge, miljö, kursriktning och hastighet. En viktig del i autonom navigering för drönare är att den kan samtidigt kartlägga omgivningen och lokalisera sig själv i omgivningen. 

Med kameror kan man extrahera egenskaper ur bilder och kameror är inte beroende på utomstående entitet för att skaffa data om omgivningen. Visionsbaserad navigering med kameror är ett primärt forskningsområde inom robotnavigering. Syftet med denna avhandling är att undersöka visionsbaserad navigering från drönarens perspektiv med fokus på samtidig kartläggning och lokalisering och hur detta problem har angripits.
\end{abstract}
